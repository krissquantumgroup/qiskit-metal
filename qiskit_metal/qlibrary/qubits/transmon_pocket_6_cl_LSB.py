...
##$!@#$=@=#$@!#$@!#$!@$#=!@#$!@$#!!=!!@#=$=@#$!@$#!@#$!=@$#=!@$#
#============ Hello i am SongbinLim.===============
# Al of this code is copied from "transmon_pocket_cl.py"
# I just changed the Parentclass from "TransmonPocket" to "TransmonPocket6"
##$!@#$=@=#$@!#$@!#$!@$#=!@#$!@$#!!=!!@#=$=@#$!@$#!@#$!=@$#=!@$#
"""Transmon Pocket CL.
...
# from qiskit_metal.qlibrary.qubits.transmon_pocket import TransmonPocket # The Original version
from qiskit_metal.qlibrary.qubits.transmon_pocket_6_LSB import TransmonPocket6_LSB


class TransmonPocket6CL_LSB(TransmonPocket6_LSB):  # pylint: disable=invalid-name
    ...
    TransmonPocket6 Default Options:
        ...
        * _default_connection_pads: Dict
            ...
            * maybe 0 could be possible?ByLSB, 250213
...
#####################################################################
    ...
    def make_charge_line(self):
        ...
        self.add_qgeometry('poly', dict(cl_metal=cl_metal), chip=chip)
        self.add_qgeometry('poly', dict(cl_etcher=cl_etcher), subtract=True, chip=chip)

        # Generating pins
        points = list(draw.shapely.geometry.shape(port_line).coords)
        self.add_pin(name, points, p.cl_width, chip=chip)
